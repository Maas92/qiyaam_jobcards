...
userSchema.pre('save', async function (next) {
  if (!this.isModified('password')) return next(); // If the password is NOT modified keep it moving along
...
userSchema.pre(/^find/, function (next) {
  // regex to work on all queries that begin with find so even findbyid
